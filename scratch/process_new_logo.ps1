...
$inputFile = "C:\Users\HP\.gemini\antigravity\brain\379c59c2-84ff-4a97-a8ed-791e60c8f282\media__1780331753185.jpg"
...
Write-Host "Converting checkerboard background to transparency..."
...
for ($x = 0; $x -lt $width; $x++) {
    for ($y = 0; $y -lt $height; $y++) {
        ...
        # If it is close to gray/white (low saturation) and relatively bright (RGB above 170)
        # Note: Checkerboard gray is around (207,207,207) and white is (255,255,255).
        # We also want to capture compression artifacts around the text by matching within a tolerance.
        if ($diffRG -lt 18 -and $diffGB -lt 18 -and $diffRB -lt 18 -and $pixel.R -gt 170) {
